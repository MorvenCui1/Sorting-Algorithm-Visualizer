...
import {getRadixSortAnimations} from '../SortingAlgorithms/SortingAlgorithms.js';
  ...
  render() {
    ...
    return (
      ...
      <div class = "button-container-two">
        ...
        <button onClick={() => this.radixSort()} className = "custom-button-two">Radix Sort</button>
